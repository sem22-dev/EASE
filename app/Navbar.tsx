...
export default  function Navbar() {
    ...
    return (
        <nav style={{ backdropFilter: 'blur(4.7px)' }} className={` ${pathname === '/LiveStream' ? 'hidden' : 'flex'} z-50 justify-center items-center fixed top-5 left-0 right-0 mx-12 rounded-full px-2 sm:px-6 lg:px-2 xl:px-7 bg-white shadow-md`}>

            {/* for screen larger than md */}
            <div className="py-3  w-full hidden lg:flex justify-between text-base text-black items-center">
                <div>     
                ...
                <div className="flex items-center  gap-4">
                    ...
                    <Link href={'/'}><button className=" bg-[#23272A] hover:bg-hoverbrand hover:text-white border border-transparent  transition-all duration-100 text-white py-1.5 px-4 rounded-md">List your event</button></Link>
                </div>
            </div>
